...
def inject_customizations(pre_init, cloud_init):
    """
    Inject cloud init style customizations into an ami/cloud init script given
    by user Replaces the old nimbus style xml.
    """
    ...
    for initscript in pre_init:
        ...
        # Need to iterate with index counts as well
        for i, line in enumerate(splitscript):
